...
pub(crate) const HEADER_FLAG_AEAD: u16 = 1 << 5;
pub(crate) const REQUIRED_HEADER_FLAGS: u16 =
    HEADER_FLAG_TOC_LZ4 | HEADER_FLAG_CHUNKED | HEADER_FLAG_XXH3;
pub(crate) const KNOWN_HEADER_FLAGS: u16 =
    REQUIRED_HEADER_FLAGS | HEADER_FLAG_TOC_XOR | HEADER_FLAG_PATHS_STRIPPED | HEADER_FLAG_AEAD;
